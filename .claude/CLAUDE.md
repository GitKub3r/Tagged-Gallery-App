...
- **Reglas:** automatizaciones del usuario construidas como un workflow de nodos, al estilo de n8n. Un disparador (media añadida, editada, restaurada o ejecución manual) lleva a condiciones (tags, nombre, autor, tamaño, resolución, orientación, tipo, favorito, si estuvo en la papelera) con salidas "True" y "False", y estas a acciones (añadir o quitar tags, marcar o desmarcar favorito, añadir a un álbum). Solo se ejecutan las reglas activas y completas; también se pueden aplicar a toda la biblioteca con "Run rule".
