export const AlbumEditModal = ({
    ...
    return (
        <div
            ...
            role="dialog"
            aria-modal="true"
            aria-labelledby="tagged-album-edit-modal-title"
            onClick={onClose}
        >
            <div
                className={`tagged-album-modal-content tagged-album-edit-modal-content ${modalContentClassName}`.trim()}
                onClick={(event) => event.stopPropagation()}
            >
                <header className="tagged-album-modal-header">
                    <div>
                        <h2 id="tagged-album-edit-modal-title">Edit album</h2>
                    </div>
                        ...
                        <div className="tagged-album-edit-main-column">
                            ...
                            {imageMediaItems.length === 0 ? (
                                <div className="tagged-album-media-empty" aria-live="polite">
                                    ...
                                    <p>You have no image media available to set as cover.</p>
                                </div>
