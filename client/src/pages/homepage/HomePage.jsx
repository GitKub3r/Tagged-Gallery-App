    ...
    return (
        <main className="relative min-h-dvh overflow-hidden bg-neutral-100 text-neutral-950 transition-colors dark:bg-neutral-950 dark:text-neutral-100">
            ...
            <div className="relative grid min-h-dvh w-full bg-neutral-50 lg:grid-cols-12 dark:bg-neutral-900">
                ...
                <section className="relative flex min-h-dvh items-center justify-center overflow-hidden border-t border-neutral-800 bg-neutral-950 p-6 text-neutral-100 sm:p-8 lg:col-span-7 lg:border-l lg:border-t-0 lg:p-12" aria-label="Redesign in progress">
