                ...
                <nav className="flex min-h-0 flex-1 flex-col gap-3 overflow-y-auto p-3" aria-label="Main navigation">
                    ...
                    {user?.type === "dev" ? (
                        <section className="border-t border-neutral-200 pt-3 dark:border-neutral-800" aria-label="Developer navigation">
                            ...
                            <button type="button" className={`${navItemClassName(forceLoading, isCollapsed)} w-full`} onClick={() => setForceLoading(!forceLoading)} aria-pressed={forceLoading} aria-label="Toggle loading preview mode" title={isCollapsed ? "Loading mode" : undefined}>
