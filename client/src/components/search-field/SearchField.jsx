...
export const SearchField = ({ value, onChange, placeholder, label, disabled = false, onFocus, onBlur, onKeyDown, onClear, className = "", inputClassName = "" }) => (
